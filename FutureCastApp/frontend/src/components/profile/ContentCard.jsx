...
const PredictionItem = ({ prediction }) => (
  <div className="card-content">
    ...
    <ReactionSummary prediction={prediction} />
  </div>
);
...
const Reaction = ({ type, count }) => (
  <div className="flex text-sm text-primaryText dark:text-darkPrimaryText mt-1">
    <span className="size-4 mr-1">
      {/* Add respective SVG here */}
      {type === "Agree" && (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
